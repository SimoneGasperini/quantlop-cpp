...
inline double inf_norm(const std::complex<double> *psi, std::size_t dim)
{
    double norm = 0.0;
...
inline void expm_multiply_into(const Hamiltonian &ham, const std::complex<double> *psi, std::size_t dim,
                               std::complex<double> *out)
{
    const double tol = std::ldexp(1.0, -24);
    const auto [m_star, s] = fragment_3_1(ham);
    std::vector<std::complex<double>> b(psi, psi + dim);
...
inline std::size_t expm_multiply_trace_into(const Hamiltonian &ham, const std::complex<double> *psi,
                                            std::size_t dim, std::complex<double> *out)
{
    const double tol = std::ldexp(1.0, -16);
    const auto [m_star, s] = fragment_3_1(ham);
    std::vector<std::complex<double>> b(psi, psi + dim);
    std::vector<std::complex<double>> f(psi, psi + dim);
    std::vector<std::complex<double>> tmp(dim);
...
inline void evolve_into(const Hamiltonian &ham, const std::complex<double> *psi, std::size_t dim,
                        std::complex<double> *out, std::complex<double> coeff = std::complex<double>(1.0, 0.0))
{
...
inline std::size_t trace_evolve_into(const Hamiltonian &ham, const std::complex<double> *psi, std::size_t dim,
                                     std::complex<double> *out, std::complex<double> coeff = std::complex<double>(1.0, 0.0))
{
    const std::complex<double> i(0.0, 1.0);
    const Hamiltonian expm = (-i * coeff) * ham;
